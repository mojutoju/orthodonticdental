...
<center>
    ...
    <h1 style="font-weight:800;"> Tracking </h1>
    ...
    <img src="img/dispatch.png" class="img-fluid">
       ...
       <div class="col-md-6 mb-2">
           ...
           <hr>
             ...
             <p style="font-weight:bold;"> Enter your Tracking No </p>
             <hr>
            
    <form name="tracking" method="POST" action="trackresults.php">
        
    <div class="form-group">
        <input type="text" class="form-control"  name="trackingno" style="padding:25px; border-radius:20px; font-size:13px;" placeholder="Track Orders by providing your tracking ID" required>
...
<div class="form-group">
        ...
        <input type="submit" class="btn btn " value="Search" style="background-color: #E61561; color:white;" name="tracking">
