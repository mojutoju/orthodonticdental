...
if(isset($_POST['login'])){
 ...
 $password = md5($password);
  ...
  $sql = mysqli_query($dbc, "SELECT * FROM `orthodonticdental` WHERE `email` = '".$uname."' AND `password` = '".$password."'  ");
...
<div class="main">
    ...
    &nbsp; &nbsp;
                  ...
                  <p style="color:white; text-align:center;"> Go back to Landing Page ? <a href="../index.php" style="color:#3FB7A4; text-align:center;"> Click Here</a>  </p>
