...
<div class="main-panel">
        <div class="content-wrapper">
              ...
              <div class="container">
                  ...
                  <h3 class="font-weight-bold">Manage Blog Posts </h3>
           <hr>
    ...
    if(isset($_GET['blog_id'])){
        ...
        $delete = mysqli_query($dbc, "DELETE FROM `blogs` WHERE `blog_id` = '$id' ");
...
<input type="text" class="form-control" id="myInput" onkeyup="myFunction()" placeholder="Search and filter blog posts..." title="Type in a name" style="font-size:13px;">
</div>
