...
<hr>
        ...
        if(isset($_GET['productid'])){
            ...
            $delete = mysqli_query($dbc, "DELETE FROM `products` WHERE `productid` = '$id' ");
  ...
  // Your application has indicated there's an error
    window.setTimeout(function(){
        ...
        ?>
                ...
                <input type="text" class="form-control" id="myInput" onkeyup="myFunction()" placeholder="Search and filter product names..." title="Type in a name" style="font-size:13px;">
...
$productselect =  "SELECT * FROM products  WHERE `emailid` = '".$_SESSION['login']."' ";   
