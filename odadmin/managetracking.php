...
<div class="main-panel">
        <div class="content-wrapper">
              ...
              <div class="container">
                  ...
                  <h3 class="font-weight-bold">Manage Tracking Details </h3>
           <hr>
    ...
    if(isset($_GET['trackingno'])){
        ...
        $delete = mysqli_query($dbc, "DELETE FROM `tracking` WHERE `trackingno` = '$id' ");
...
<script>
 ...
 <?php
  ...
  echo "<script>window.location.replace('managetracking.php');</script>";
...
?>
           ...
           <input type="text" class="form-control" id="myInput" onkeyup="myFunction()" placeholder="Search and filter tracking details..." title="Type in a name" style="font-size:13px;">
...
$track = mysqli_query($dbc,"SELECT * FROM `tracking` WHERE 1  ");
...
?>
   ...
   <a href="viewtracking.php?trackingno=<?php echo $trackingid; ?>" class="btn btn-success btn-sm"> View </a>
        ...
        <td>
   <a href="trackingupdate.php?trackingno=<?php echo $trackingid; ?>" class="btn btn-warning btn-sm"> Update </a>
        </td>

        <td>
            <a href="managetracking.php?trackingno=<?php echo $trackingid; ?>" class="btn btn-danger btn-sm"> <i class="fa fa-trash"></i> </a>
        </td>
