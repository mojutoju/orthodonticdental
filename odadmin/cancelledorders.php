...
<div class="main-panel">
        <div class="content-wrapper">
              ...
              <div class="container">
                  ...
                  <h3 class="font-weight-bold">Cancelled Orders </h3>
           <hr>
        ...
        if(isset($_GET['orderid'])){
            ...
            $delete = mysqli_query($dbc, "DELETE FROM `orders` WHERE `orderid` = '$id' ");
            if($delete){
  ...
  // Your application has indicated there's an error
    window.setTimeout(function(){
        ...
        window.location.href = "cancelledorders.php";
        ...
        ?>
           ...
           <input type="text" class="form-control" id="myInput" onkeyup="myFunction()" placeholder="Search and filter order names..." title="Type in a name" style="font-size:13px;">
...
<?php
  ...
  $orders = mysqli_query($dbc,"SELECT * FROM `orders` WHERE  `confirmation` = 'Cancelled'  ");
...
?>
   ...
   <a href="vieworder.php?orderid=<?php echo $orderid; ?>" class="btn btn-success btn-sm"> View </a>
        ...
        <td>
            <a onclick="return confirm('Are you sure you want to delete this order ?\n. Click \'OK\' to continue or \'Cancel\' to go back.');"  class="btn btn-danger btn-sm"  href="manageorders.php?orderid=<?php echo $orderid; ?>"> <i class="fa fa-trash"></i></a>
        </td>
