...
<div class="main-panel">
      ...
      <div class="container">
              ...
              <div class="row">
                  ...
                  <h3 class="font-weight-bold">View Category </h3>
...
$imageurl = $rows['file'];
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <img src="category/<?php echo $imageurl; ?>" class="img-fluid">
        ...
        <p> <i class="fa fa-clone"></i> Category : <?php echo $categoryname; ?> </p>
        <hr>
      
        <p> <i class="fa fa-clone"></i> Category Percentage : <?php echo $categorypercent; ?>% </p>
        <hr>
