...
<div class="main-panel">
        <div class="content-wrapper">
              ...
              <div class="container">
                  ...
                  <h3 class="font-weight-bold">Manage Brands </h3>
           <hr>
        ...
        if(isset($_GET['brandid'])){
            ...
            $delete = mysqli_query($dbc, "DELETE FROM `brands` WHERE `brandid` = '$id' ");
  ...
  // Your application has indicated there's an error
    window.setTimeout(function(){
        ...
        ?>
           ...
           <input type="text" class="form-control" id="myInput" onkeyup="myFunction()" placeholder="Search and filter brand names..." title="Type in a name" style="font-size:13px;">
...
$select = mysqli_query($dbc,"SELECT * FROM `brands` WHERE 1 ");
...
?>
 ...
 Action
  ...
  <div class="dropdown-menu">
    ...
    <a onclick="return confirm('Are you sure you want to delete this brand ?\n. Click \'OK\' to continue or \'Cancel\' to go back.');" class="dropdown-item" href="managebrands.php?brandid=<?php echo $brandid; ?>">Delete</a>
  </div>
