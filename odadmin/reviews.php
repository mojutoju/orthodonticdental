        ...
        <div class="content-wrapper">
           ...
           <?php
                if(isset($_GET['review_id'])){
                    ...
                    $update = mysqli_query($dbc, "DELETE FROM `reviews` WHERE `review_id` = '$reviewid' ");
...
$commentz = mysqli_query($dbc,"SELECT * FROM `reviews` WHERE 1   ");
if(mysqli_num_rows($commentz) > 0){
   $r = 1;
while($rows = mysqli_fetch_assoc($commentz)){
$fullname = $rows['fullname'];
$comment = $rows['comment'];
$rating = $rows['rating'];
$date = $rows['date'];
$reviewid = $rows['review_id'];
...
?>
   ...
   <tbody id="myTable">
     ...
     <tr>
       ...
       <a href="viewproducts.php?productid=<?php echo $productids; ?> "> <?php echo $productids; ?> </a>
    ...
    <td>
       ...
       <td>
  <a href="viewreviews.php?review_id=<?php echo $reviewid; ?>" class="btn btn-success btn-sm"> View </a>
       </td>
       <td>
           <a href="reviews.php?review_id=<?php echo $reviewid; ?>" class="btn btn-danger btn-sm"> <i class="fa fa-trash"></i> </a>
       </td>
