...
<div class="main-panel">
        ...
        if(isset($_POST['category'])){
            ...
            $categorypercent = $_POST['categorypercent'];
...
echo "
  ...
  <strong>Error!</strong> Invalid format make sure you upload jpg or png.
...
echo "  ";
  ...
  if($_FILES['file']['size'] <= $limit_size)
  {
   ...
   <div class='container'>
   <div class='alert alert-danger alert-dismissible fade show' role='alert'>
  <strong>Error!</strong> Invalid size
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
  </button>
</div>
...
$pic = mysqli_query($dbc, "SELECT * FROM categorymaster WHERE  `categoryname` = '$categoryname'  ");
  ...
  title: "Category already Exists.",
    icon: "error",
     ...
     <?php
               ...
               $insert = mysqli_query($dbc, "INSERT INTO `categorymaster` VALUES(NULL, '$categoryname', '$categorypercent', '$file', '$size', '$content', '$type', '$location', now()) ");
               ...
               if($insert){
                   ...
                   <script>
                                      swal({
  title: "<?php echo $categoryname; ?> has been created",
    icon: "success",
...
echo "  ";
  ...
  if($file){
    $location = "subcategory/$file";
    move_uploaded_file($tmp_name, $location);
   
            
            
$pic = mysqli_query($dbc, "SELECT * FROM subcategory WHERE  `subcategoryname` = '$subcategoryname'  ");
$row = mysqli_fetch_assoc($pic);
           $countrows = mysqli_num_rows($pic);
           if($countrows == 1){
  ...
  title: "Subcategory already Exists.",
    icon: "error",
     ...
     <?php
               ...
               $insert = mysqli_query($dbc, "INSERT INTO `subcategory` VALUES(NULL, '$file', '$size', '$content', '$type', '$location', 
              '$subcategoryname', '$categoryname' , now()) ");
               ...
               if($insert){
                   ...
                   <script>
                                      swal({
  title: "<?php echo $subcategoryname; ?> has been created",
    icon: "success",
...
<label style="font-size:13px;"> Select Image</label>
<br>
...
<img class="img-fluid img-thumbnail" id="output"/>
       ...
       <div class="col-md-4 mb-3">
        ...
        <input type="text" class="form-control" style="font-size:13px;" required="" name="categoryname" placeholder="Category Name">
    </div>
    
       <div class="col-md-4 mb-3">
        <label style="font-size:13px;"> Set Commission Percentage (%) </label>
        <input type="number" class="form-control" name="categorypercent" placeholder="Enter Category Percentage Number" style="font-size:13px;"  
       onchange="setTwoNumberDecimal" min="0" max="10" step="0.25"  required="">
  ...
  <div class="form-group">
      <input type="submit" name="category" class="btn btn-primary" value="Create Category" style="border-radius: 25px;">
  </div>
  ...
  <br><br>
           ...
           <h3 style="font-weight:800;">Create Subcategory </h3>
            <p> Create your subcategory and assign it to an existing category </p>
           <hr>
 
  <form name="subcategory" method="POST" action="createcategory.php"  enctype="multipart/form-data">
...
<label style="font-size:13px;"> Select Image</label>
<br>
<input type="file" name="file" class="form-control"  onchange="readURL(this);"  accept="image/*" style="font-size:13px;" required>
<img id="blah" src=" " class="img-fluid" alt="" />
       ...
       <div class="col-md-4 mb-3">
        ...
        <input type="text" class="form-control" style="font-size:13px;" required="" name="subcategoryname" placeholder="Subcategory Name">
    </div>
      ...
      <select name="categoryname" class="form-control" style="font-size:13px;" required="">
          <option value=""> - Select existing category names</option>
...
$orders = mysqli_query($dbc,"SELECT * FROM `categorymaster` WHERE 1  ");
...
?>
  ...
  <div class="form-group">
      <input type="submit" name="subcategory" class="btn btn-success" value="Create Subcategory" style="border-radius: 25px;">
  </div>
