...
<div class="main-panel">
        <div class="content-wrapper">
              ...
              <div class="container">
                  ...
                  <h3 class="font-weight-bold">Upload Tracking Info </h3>
           <hr>
...
<script>
                            swal({
  title: "Success Track Information Uploaded.",
    icon: "success",
...
?>
      ...
      <form name="tracking" method="POST" action="ordertracking.php?trackingno=<?php echo $trackingid; ?>">
