...
<div class="main-panel">
        <div class="content-wrapper">
              ...
              <div class="container">
                  ...
                  <h3 class="font-weight-bold">View Receipt</h3>
           <hr>
...
if(isset($_GET['invoiceno'])){
    ...
    $orderz = mysqli_query($dbc,"SELECT * FROM `orders` WHERE invoiceno = '$invoiceno' ");
...
$orders = mysqli_query($dbc,"SELECT * FROM `orders` WHERE  invoiceno = '$invoiceno' ");
