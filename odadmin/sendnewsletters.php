...
<div class="main-panel">
        <div class="content-wrapper">
              ...
              <div class="container">
                  ...
                  <h3 class="font-weight-bold">Send Newsletter </h3>
           <hr>
...
if(isset($_POST['updates'])){
    ...
    $break =  htmlspecialchars_decode($editor1); 
    
    $sql = "SELECT email FROM subscribe WHERE status = 'Subscribed' ";
...
<script>
    ...
    swal({
          text: "Success",
  title: "Newsletter sent to all emails that Subscribed. ",
...
<script>
    ...
    swal({
          text: "Error",
  title: "Email Delivery failed, kindly contact admin. ",
...
?>
           ...
           <form name="updates" method="POST" action="sendnewsletters.php"  enctype="multipart/form-data">
...
filebrowserUploadUrl: 'ck_upload.php',
  filebrowserUploadMethod: "form"
    ...
    <input type="submit" class="btn btn-success" value="Post" name="updates" style="border-radius:30px;">
