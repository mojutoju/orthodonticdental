...
<h3 class="font-weight-bold"> <i class="fa fa-list"> </i> Manage Categories </h3>
...
<div class="dropdown-menu">
      <a class="dropdown-item" href="showcategories.php">Show All</a>
    </div>
    </div>
...
<?php
  ...
  $or = mysqli_query($dbc,"SELECT * FROM `categorymaster` WHERE 1 ORDER BY categoryname  ");
   ...
   <a href="editcategory.php?catid=<?php echo $catid; ?>" class="btn btn-success btn-sm"> Edit </a>
        ...
        <td>
            <a class="btn btn-primary btn-sm"  href="viewcategory.php?catid=<?php echo $catid; ?>"> View </a>
             ...
             <td>
            <a class="btn btn-danger btn-sm"  href="showcategories.php?catid=<?php echo $catid; ?>"> <i class="fa fa-trash"></i> </a>
        </td>
