...
?>
           ...
           <input type="text" class="form-control" id="myInput" onkeyup="myFunction()" placeholder="Search and filter customers names..." title="Type in a name" style="font-size:13px;">
...
$select = mysqli_query($dbc,"SELECT * FROM `customers` WHERE 1 ");
...
<!-- Small button group -->
 ...
 Action
  ...
  <div class="dropdown-menu">
    ...
    <a class="dropdown-item" href="viewuser.php?id=<?php echo $customerid; ?>&email=<?php echo $email; ?>">View</a>
