...
$select =  "SELECT * FROM products  WHERE `productid` = '$productid' AND `emailid` = '".$_SESSION['login']."' ";  
...
<script>
                            swal({
  title: "Category Matched, Product Upload Successful",
    icon: "success",
...
$update = mysqli_query($dbc, "UPDATE `products` SET `productname`='$productname',`brandname`='$brandname',`category`='$category',`subcategory`='$subcategory',`amount`='$amount',`producttype`='$producttype',`productsize`='$productsize',`color`='$color',`quantity`='$quantity', `delivery` = '$delivery',`phoneno`='$phoneno',`state`='$state',`city`='$city',`description`='$description' WHERE productid = '$productid' ");
...
?>
    ...
    <form name="products" action="editproducts.php?productid=<?php echo $productid; ?>" method="post" enctype="multipart/form-data" >
        ...
        <div class="row">
            ...
            <div class="col-xl-2 mb-3">
               ...
               <img src="productimages/<?php echo $file; ?>" class="img-fluid img-thumbnail" width="600">
       ...
       <div class="col-lg-4 mb-2">
           ...
           <input type="text" class="form-control" style="font-size:13px;" name="productname" value="<?php echo $productname; ?>"  >
           
                <br>
                
    
               <select name="brandname" class="form-control" style="font-size:13px;" > 
                
                     <option value=""> -- Select Brand Name -- </option>     
                      <option value="<?php echo $brandname; ?>" selected="selected"> Brand :<?php echo $brandname; ?>   </option>
                     
                
<?php
$brandz = mysqli_query($dbc,"SELECT * FROM `brands` WHERE emailid = '".$_SESSION['login']."'");
...
<select id="type" class="form-control" name="category" style="font-size:13px;">
<option value=""> -- Select a Category -- </option>
<option selected="selected" value="<?php echo $category; ?>"> Category : <?php echo $category; ?> </option>
    <?php
...
<select id="size" name="subcategory" class="form-control" style="font-size:13px;">
    <option value="">-- Select a Subcategory -- </option>
    <option selected="selected" value="<?php echo $subcategory; ?>"> Subcategory : <?php echo $subcategory; ?> </option>
...
<input type="number" class="form-control" style="font-size:13px;" name="amount" value="<?php echo $amount; ?>">
...
<select name="producttype" class="form-control" style="font-size:13px;" >
  <option value="">-- Select Product Type -- </option>
  <option selected="selected" value="<?php echo $producttype; ?>"> Product Type : <?php echo $producttype; ?> </option>
  ...
  <option value="Brand New"> Brand New </option>
           ...
           <br>
              ...
              <input type="number" name="productsize" class="form-control" style="font-size:13px;"  value="<?php echo $productsize; ?>">
...
<option value="<?php echo $color; ?>" selected="selected"> Color : <?php echo $color; ?>  </option>
...
<br>
  ...
  <input type="number" name="quantity" class="form-control" style="font-size:13px;" value="<?php echo $quantity; ?>">
...
<option value="<?php echo $delivery; ?>"> Pay on Delivery - <?php echo $delivery; ?></option>
...
<option value="No"> No </option>
      ...
      <input type="text" class="form-control" name="phoneno"  style="font-size:13px;"   onkeydown="return ( event.ctrlKey || event.altKey || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false) 
                    || (95<event.keyCode && event.keyCode<106)
                    || (event.keyCode==8) || (event.keyCode==9) 
                    || (event.keyCode>34 && event.keyCode<40) 
                    || (event.keyCode==46) )" value="<?php echo $phoneno; ?>" >
           <br>
             ...
             <select
                ...
                >
                  ...
                  <option selected="selected" value="<?php echo $state; ?>"> Business Location : <?php echo $state; ?> </option>
       ...
       <select name="city" id="lga" style="font-size:13px;"  class="form-control select-lga" required>
           ...
           <option value="<?php echo $city; ?>" selected="selected"> City : <?php  echo $city; ?></option>
                </select>
...
<textarea class="form-control" name="description" rows="7" cols="15" style="font-size:13px;"> <?php echo $description; ?> </textarea>
...
<input type="hidden" name="status" value="approve">
         ...
         <input type="submit" class="btn btn" value="Update Product" name="products" style="background-color: #3FB7A4; color:white; border-radius: 30px;">
