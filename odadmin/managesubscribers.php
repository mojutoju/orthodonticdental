...
<div class="main-panel">
        <div class="content-wrapper">
              ...
              <div class="container">
                  ...
                  <h3 class="font-weight-bold">Manage Subscribers </h3>
           <hr>
    ...
    if(isset($_GET['subscribe_id'])){
        ...
        $delete = mysqli_query($dbc, "DELETE FROM `subscribe` WHERE `subscribe_id` = '$id' ");
...
<script>
 ...
 <?php
  ...
  echo "<script>window.location.replace('managesubscribers.php');</script>";
...
$limit = 20;
  $or = mysqli_query($dbc,"SELECT * FROM `subscribe` WHERE 1 ORDER BY email DESC LIMIT 0, $limit  ");
if(mysqli_num_rows($or) > 0){
    $ord = 1;
 while($rows = mysqli_fetch_assoc($or)){
$email = $rows['email'];
$id = $rows['subscribe_id'];
$status = $rows['status'];
...
if($status == "Subscribed"){
  ...
  ?>
<button class="btn btn-success btn-sm"> <?php echo $status; ?> </button>
  <?php
}else{

  ?>
<button class="btn btn-danger btn-sm"> Unsubscribed </button>
  ...
  <?php
       ...
       ?>
             ...
             <td>
            <a onclick="return confirm('Are you sure you want to delete this subscriber ?\n. Click \'OK\' to continue or \'Cancel\' to go back.');"  class="btn btn-danger btn-sm"  href="managesubscribers.php?subscribe_id=<?php echo $id; ?>"> <i class="fa fa-trash"></i> </a>
        </td>
