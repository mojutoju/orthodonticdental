        ...
        <div class="content-wrapper">
           ...
           <?php
                if(isset($_GET['id']) && isset($_GET['email'])){
                 ...
                 $select = mysqli_query($dbc,"SELECT * FROM `customers` WHERE `id` = '$customerid' ");
...
$phoneno = $rows['phoneno'];
  ...
  <img src="https://icons.iconarchive.com/icons/paomedia/small-n-flat/512/user-male-icon.png" class="img-fluid">
...
<!-- Card -->
  ...
  <!-- Content -->
    ...
    <!-- Name -->
    <h6 class="card-title"> <?php echo $fname; ?> <?php echo $lname; ?> </h6>
    <hr>
    <!-- Quotation -->
...
<hr>
 <p>  <i class="fa fa-map-marker"></i> <?php echo $state; ?> | <i class="fa fa-lock"></i> <?php echo $password; ?> </p>
<hr>
