...
<div class="main-panel">
        <div class="content-wrapper">
              ...
              <div class="container">
                  ...
                  <h3 class="font-weight-bold">Confirmed Orders </h3>
           <hr>
  ...
  // Your application has indicated there's an error
    window.setTimeout(function(){
        ...
        window.location.href = "confirmedorders.php";
...
<?php
  ...
  $orders = mysqli_query($dbc,"SELECT * FROM `orders` WHERE  `confirmation` = 'Confirmed'  ");
