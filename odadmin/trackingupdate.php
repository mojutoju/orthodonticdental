...
<div class="main-panel">
        <div class="content-wrapper">
              ...
              <div class="container">
                  ...
                  <h3 class="font-weight-bold">Tracking Details </h3>
           <hr>
...
if(isset($_POST['tracking'])){
    ...
    $trackstatuss = $_POST['trackstatus'];
    $descriptionss = $_POST['description'];
    $currentstates = $_POST['currentstate'];
    $citys = $_POST['city'];
    $trackid =  $_POST['trackid'];


    $update = mysqli_query($dbc, "UPDATE `tracking` SET `trackstatus` = '$trackstatuss' , `description` = '$descriptionss' , `currentstate` = '$currentstates', `city` = '$citys' WHERE `trackid` = '$trackid' ");
...
?>
      ...
      <form name="tracking" method="POST" action="trackingupdate.php?trackingno=<?php echo $trackingid; ?>">
          
          <div class="row">
              
              <input type="hidden" class="form-control" name="trackid" value="<?php echo $rows['trackid']; ?>" >
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <h5> View Tracking Information </h5>
          
          <hr>
          
         <div class="form-group">
          <label style="font-size:13px;"> <i class="fa fa-truck"></i> Tracking Status  </label>
         <select name="trackstatus" class="form-control" style="font-size:13px;" >
<option value=""> - Select your Tracking Status - </option>
<option selected="selected" value="<?php echo $trackstatus; ?>"> Status Selected  : <?php echo $trackstatus; ?> </option>
...
<option value=" Waiting   "> Waiting </option>
      ...
      value="<?php echo $descriptions; ?>" style="font-size:13px;"> <?php echo $descriptions; ?></textarea>   
      </div>     
          ...
          <div class="col-6 mb-3">
             ...
             <select
                ...
                >
                  ...
                  <option selected="selected" value="<?php echo $currentstate; ?>"> State Selected : <?php echo $currentstate; ?> </option>
           ...
           <option selected="selected" value="<?php echo $city; ?>"> Selected City : <?php echo $city; ?> </option>
                </select>
                </div>
      ...
      <input type="submit" class="btn btn-success" name="tracking" value="Update Tracking" >
