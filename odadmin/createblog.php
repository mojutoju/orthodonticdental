...
<div class="main-panel">
        <div class="content-wrapper">
              ...
              <div class="container">
                  ...
                  <h3 class="font-weight-bold">Create Blog Posts </h3>
           <hr>
...
$insert = mysqli_query($dbc, "INSERT INTO `blogs` VALUES (NULL, '$title', '$authorname',  '$file', '$size', '$content', '$type', '$location', '$description' , '$editor1', now())  ");
...
<script>
    ...
    swal({
          text: "Success",
  title: " <?php echo $projectname; ?> Posted  ",
...
?>
      ...
      <form name="blog" method="POST" action="createblog.php"  enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" style="font-size:13px;" placeholder="Title of the Blog Post" name="title" required>
        </div>
        ...
        <div class="form-group">
              ...
              <label style="font-size:13px;"> Author Name</label>
                <input type="text"  name="authorname" class="form-control" required="" placeholder="Author Name" style="font-size:13px;"  />
            </div>
       
        
          <div class="form-group">
            <label style="font-size:13px;"> Upload Blog Post Cover </label>
            <input type="file" class="form-control" name="file" style="font-size:13px;" required>
        </div>
        
        
        
        <div class="form-group">
            <label style="font-size:13px;"> Description (max:300words) </label>
            <textarea cols="10" rows="10" name="description" class="form-control" maxlength="300" placeholder="Type here" required></textarea>
...
<textarea name="editor1" class="form-control" rows="5" cols="10" required></textarea>
    ...
    filebrowserUploadUrl: 'ck_upload.php',
      filebrowserUploadMethod: "form"
        ...
        <input type="submit" class="btn btn-success" value="Create Blog Post" name="blog" style="border-radius: 25px; ">
...
<script>
        ...
        $("form").submit( function(e) {
            ...
            if( !messageLength ) {
                alert( 'Blog Details Field is Required' );
                e.preventDefault();
            }
        });
    </script>
