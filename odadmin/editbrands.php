...
<div class="main-panel">
        <div class="content-wrapper">
              ...
              <div class="container">
                  ...
                  <h3 class="font-weight-bold">Edit Brand </h3>
           <hr>
...
$date = $rows['date'];
    ...
    if(isset($_POST['brands'])){
         ...
         $update = mysqli_query($dbc, " UPDATE `brands` SET `brandname`= '$brandname',`phoneno`='$phoneno',`instagram`='$instagram',`whatsapp`='$whatsapp',`facebook`='$facebook',`others`='$others',`state`='$state',`city`='$city',`address`='$address',`description`='$description' WHERE `brandid` = '$brandid' ");
...
if($update){
 ...
 <?php
    ...
    <form name="brands" action="editbrands.php?brandid=<?php echo $brandid; ?>" method="post" enctype="multipart/form-data" >
...
<label style="font-size:13px;"> Brand Name </label>
           <input type="text" class="form-control" style="font-size:13px;" name="brandname" value="<?php echo $brandname; ?>" >
...
<label style="font-size:13px;"> Phone No </label>
      <input type="text" class="form-control" name="phoneno" value="<?php echo $phoneno; ?>" style="font-size:13px;"   onkeydown="return ( event.ctrlKey || event.altKey || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false) 
...
<label style="font-size:13px;"> Social Media (Instagram) </label>
           <input type="text" class="form-control" style="font-size:13px;" name="instagram" value="<?php echo $instagram; ?>" >
           
           <br>
           
           
                    
<label style="font-size:13px;"> Social Media (WhatsApp) </label>
           <input type="number" class="form-control" style="font-size:13px;" name="whatsapp" value="<?php echo $whatsapp; ?>" >
...
<label style="font-size:13px;"> Social Media (Facebook)  </label>
     <input type="text" class="form-control" style="font-size:13px;" name="facebook" value="<?php echo $facebook; ?>" >
           
           <br>
           
                      
<label style="font-size:13px;"> Other Details </label>
               <input type="text" class="form-control" style="font-size:13px;" name="others" value="<?php echo $others; ?> " >
...
<label style="font-size:13px;"> Business Location  </label>
...
<label style="font-size:13px;"> In what City ? </label>
...
<textarea class="form-control"   name="address" rows="7" cols="30" style="font-size:13px;"> <?php echo $address; ?> </textarea>

<br>

           
<label style="font-size:13px;"> Description </label>
<textarea class="form-control"  name="description" rows="7" cols="30" style="font-size:13px;"> <?php echo $description; ?></textarea>
...
<input type="hidden" name="status" value="approve">
         ...
         <input type="submit" class="btn btn" value="Update Brand" name="brands" style="background-color: #3FB7A4; color:white; border-radius: 25px;">
