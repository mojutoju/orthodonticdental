...
<div class="main-panel">
        ...
        <div class="container">
              <div class="row">
                  ...
                  <h3 class="font-weight-bold">View Subcategory </h3>
...
$imageurl = $rows['file'];
        ...
        ?>
                    ...
                    <div class="col-md-6 mb-3">
                         <h6> <i class="fa fa-clone"></i> Category Name : <?php echo $categoryname; ?> </h6>
                   
                     
                  
                     <hr>
                     
                         <h6> <i class="fa fa-clone"></i> Subcategory Name : <?php echo $subcategoryname; ?> </h6>
