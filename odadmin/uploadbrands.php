...
<div class="main-panel">
        <div class="content-wrapper">
              ...
              <div class="container">
                  ...
                  <h3 class="font-weight-bold">Upload Brands </h3>
           <hr>
     ...
     if(isset($_POST['brands'])){
        $emailid = $_SESSION['login'];
         ...
         $whatsapp = mysqli_real_escape_string($dbc,$_POST['whatsapp']);
         $facebook = mysqli_real_escape_string($dbc, $_POST['facebook']);
         $others = mysqli_real_escape_string($dbc, $_POST['others']);
...
<script>
                                      swal({
  title: "Invalid Size, make sure size is lesser than 9mb",
    icon: "success",
...
<?php
  ...
  if($file){
    $location = "brands/$file";
    move_uploaded_file($tmp_name, $location);
    
    
               
$pic = mysqli_query($dbc, "SELECT * FROM brands WHERE `brandname` = '$brandname'  ");
$row = mysqli_fetch_assoc($pic);
  ...
  $brands = mysqli_query($dbc, "INSERT INTO `brands` VALUES (NULL,'$emailid', '$sellername', '$file', '$size', '$content', '$type', '$location', '$brandname' , '$phoneno', '$instagram' ,  '$whatsapp' , '$facebook', '$others', '$state' , '$city', '$address' , '$description' , '$status'  , now()) ");
...
?>
  ...
  <script>
                                      swal({
  title: "<?php echo $brandname; ?> has been created",
    icon: "success",
    ...
    echo mysqli_error($dbc);
     ...
     ?>
           ...
           <form name="brands" action="uploadbrands.php" method="post" enctype="multipart/form-data" >
     ...
     <label style="font-size:13px;"> Upload Brand Logo</label>
 <br>
...
<img class="img-fluid img-thumbnail" id="output"/>
   ...
   <label style="font-size:13px;" > Brand Name</label>
           <input type="text" class="form-control" style="font-size:13px;" name="brandname" required >
...
<br>
   ...
   <label style="font-size:13px;" > Social Media (Instagram) - optional </label>
           <input type="text" class="form-control" style="font-size:13px;" name="instagram"  >
           
           <br>
           
           
            <label style="font-size:13px;" > Social Media (Whatsapp Url) - optional </label>
           <input type="text" class="form-control" style="font-size:13px;" name="whatsapp"  >
          ...
          <div class="col-lg-4 mb-2">
              <label style="font-size:13px;" > Social Media (Facebook) - optional </label>
     <input type="text" class="form-control" style="font-size:13px;" name="facebook" >
           
           <br>
              <label style="font-size:13px;" > Other Details (optional) </label>
               <input type="text" class="form-control" style="font-size:13px;" name="others"  >
           
              
             
              <br>
              
      <label style="font-size:13px;" > Where is the Business Location ? </label>         
  <select
       ...
       <select name="city" id="lga" style="font-size:13px;"  class="form-control select-lga">
...
<textarea class="form-control"   name="address" rows="7" cols="35" style="font-size:13px;" placeholder="Address"></textarea>

<br>

<textarea class="form-control"  name="description" rows="7" cols="35" style="font-size:13px;" placeholder="Description"></textarea>
...
<input type="hidden" name="status" value="approve">
         ...
         <input type="submit" class="btn btn" value="Create Brand" name="brands" style="background-color: #3FB7A4; border-radius:25px; color:white;">
