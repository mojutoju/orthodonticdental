...
<div class="main-panel">
        <div class="content-wrapper">
              ...
              <div class="container">
                  ...
                  <h3 class="font-weight-bold">Edit Blog Posts </h3>
           <hr>
...
<script>
  ...
  button: "Close",
   ...
   <?php
    ...
    $update = mysqli_query($dbc, "UPDATE `blogs` SET `title` = '$title', `authorname` = '$authorname' , `file` = '$file' , `size` = '$size', `content` = '$content', `type` = '$type', `path` = '$location',  `editor1` = '$editor1', `date` = now() WHERE `blog_id` = '$id'  ");
...
?>
      ...
      <form name="blog" method="POST" action="editblogpost.php?blog_id=<?php echo $id; ?>"  enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <label style="font-size:13px;"> Title of the Blog Post </label>
            <input type="text" class="form-control" style="font-size:13px;" name="title" value="<?php  echo $title; ?>">
        </div>
        ...
        <div class="form-group">
              ...
              <label style="font-size:13px;"> Author Name</label>
                <input type="text"  name="authorname" class="form-control"  value="<?php echo $authorname; ?>" style="font-size:13px;"  />
            </div>
        ...
        <div class="form-group">
            ...
            <textarea cols="10" rows="10" name="description" class="form-control" required><?php echo $description; ?></textarea>
...
<textarea name="editor1" class="form-control" rows="5" cols="10" required><?php  echo htmlspecialchars($editor1);?></textarea>
    ...
    filebrowserUploadUrl: 'ck_upload.php',
      filebrowserUploadMethod: "form"
        ...
        <input type="submit" class="btn btn-success" value="Update Blog Post" name="blog">
