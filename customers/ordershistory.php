...
<div class="main-panel">
        ...
        <div class="container">
              <div class="row">
                  ...
                  <h3 class="font-weight-bold">Orders History </h3>
           <hr>
...
?>
  ...
  <tbody>
    <tr>
      ...
      <td>
<a  href="checkorder.php?orderid=<?php echo $orderid; ?>"  class="btn btn-primary btn-sm">
  View
</a> 
    ...
    <?php }else if($confirmation == "Cancelled"){  ?>
    <a href="#" class="btn btn-danger btn-sm"> <?php echo $confirmation; ?>  </a>
    ...
    ?>
      ...
      <a href="#" class="btn btn-warning btn-sm"> <?php echo $confirmation; ?>  </a>
