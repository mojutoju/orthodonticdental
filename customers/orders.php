  ...
  ?>
    ...
    <tbody>
      <tr>
        ...
        <td>
  <a  href="vieworder.php?orderid=<?php echo $orderid; ?>"  class="btn btn-primary btn-sm">
    View
  </a> 
        ...
        <a onclick="alert('Are you truly satisfied with your Product ? Kindly check the product for any damage or false after confirmation you will not be able to update your order status');" class="btn btn-warning btn-sm" href="orders.php?orderid=<?php echo $orderid; ?>"> Confirm  </a>
        ...
        <td>
            ...
            <a onclick="alert('Are you sure you want to cancel order for this product ?');" href="cancelorder.php?orderid=<?php echo $orderid; ?>" class="btn btn-warning btn-sm"> Cancel </a>     
...
for ($i=1; $i<=$total_pages; $i++) {  
             ...
             <a class='page-link btn-sm ' href='ordershistory.php?page=".$i."'>".$i."</a> </li> &nbsp;&nbsp;&nbsp; ";  
};  
