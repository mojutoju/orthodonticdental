...
<div class="main-panel">
  ...
  $orders = mysqli_query($dbc,"SELECT * FROM `orders` WHERE emailid = '".$_SESSION['login']."' AND confirmation = 'Cancelled' ORDER BY orderid ASC LIMIT $start_from , $limit ");
  ...
  for ($i=1; $i<=$total_pages; $i++) {  
               ...
               <a class='page-link btn-sm ' href='cancelledorders.php?page=".$i."'>".$i."</a> </li> &nbsp;&nbsp;&nbsp; ";  
  };  
