...
<div class="main-panel">
        <div class="content-wrapper">
              ...
              <div class="row">
                  ...
                  <h3 class="font-weight-bold"> View Blog Post </h3>
           <hr>
...
<a style="color:black;" href="dashboard.php"> Home </a> /  <a style="color:black;" href="blog.php"> Blogs </a>    /  <a href="viewblog.php?blog_id=<?php echo $id; ?>"> <?php echo $title; ?> </a>
