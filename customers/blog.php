...
$select = mysqli_query($dbc,"SELECT * FROM `blogs` WHERE 1 ORDER BY date DESC LIMIT $start_from , $limit   ");
if(mysqli_num_rows($select) > 0){
$u = 1;
while($rows = mysqli_fetch_assoc($select)){
$title = $rows['title'];
...
$trimstring = substr($description, 0, 150). ' <a href="#" style="color:black;"> ...</a>';
} else {
...
<img src="https://www.dailydot.com/wp-content/uploads/e52/31/87610fa1a0ae891d.png" class="img-fluid">
</center>
