...
<div class="main-panel">
  ...
  $orders = mysqli_query($dbc,"SELECT * FROM `orders` WHERE emailid = '".$_SESSION['login']."' AND confirmation = 'Confirmed' ORDER BY orderid ASC LIMIT $start_from , $limit ");
  ...
  for ($i=1; $i<=$total_pages; $i++) {  
               ...
               <a class='page-link btn-sm ' href='confirmedorders.php?page=".$i."'>".$i."</a> </li> &nbsp;&nbsp;&nbsp; ";  
  };  
