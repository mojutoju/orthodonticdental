...
$productselect =  "SELECT * FROM products WHERE `status` = 'approve' ORDER BY productname DESC LIMIT $start_from , $limit  ";  
...
<h4 style="text-align:center; letter-spacing:1.5px; font-weight:bold;"> No Products. </h4>
...
for ($i=1; $i<=$total_pages; $i++) {  
             ...
             <a class='page-link ' href='shopping.php?page=".$i."'>".$i."</a> </li> &nbsp;&nbsp;&nbsp; ";  
};  
